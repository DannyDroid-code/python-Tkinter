...
#         self.label = tk.Label(root, font=('Helvetica', 48), fg='black', bg='white')
...
#         # Change the background and foreground color randomly
#         self.label.config(fg=self.random_color(), bg=self.random_color())
